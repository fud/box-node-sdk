...
BoxSDKNode.getPreconfiguredInstance = function (appConfig) {
  if (_typeof(appConfig.boxAppSettings) !== 'object') {
  ...
  if ((typeof webhooks === 'undefined' ? 'undefined' : _typeof(webhooks)) === 'object') {
  ...
  if (_typeof(boxAppSettings.appAuth) === 'object' && boxAppSettings.appAuth.publicKeyID) {
