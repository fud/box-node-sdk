...
function pollRepresentationInfo(client, infoURL) {
  ...
  return client.get(infoURL).then(function (response) {
...
Files.prototype.getDownloadURL = function (fileID, options, callback) {
  ...
  return this.client.get(apiPath, params).then(function (response) {
...
Files.prototype.getReadStream = function (fileID, options, callback) {
  ...
  .then(function (url) {
    return _this.client.get(url, downloadStreamOptions);
  }).asCallback(callback);
};
...
Files.prototype.addToCollection = function (fileID, collectionID, callback) {
  ...
  return this.get(fileID, { fields: 'collections' }).then(function (data) {
    ...
    return _this2.update(fileID, { collections: collections });
  }).asCallback(callback);
};
...
Files.prototype.removeFromCollection = function (fileID, collectionID, callback) {
  ...
  return this.get(fileID, { fields: 'collections' }).then(function (data) {
    ...
    return _this3.update(fileID, { collections: collections });
  }).asCallback(callback);
};
...
Files.prototype.uploadPart = function (sessionID, part, offset, totalSize, callback) {
  ...
  return this.client.put(apiURL, params).then(function (response) {
...
Files.prototype.commitUploadSession = function (sessionID, fileHash, options, callback) {
  ...
  var fetchParts = function fetchParts(offset, fetchedParts) {
    ...
    return _this4.getUploadSessionParts(sessionID, pagingOptions).then(function (data) {
  ...
  return (userParts ? Promise.resolve(userParts) : fetchParts(0, [])).then(function (parts) {

    // Commit the upload with the list of parts
    params.body.parts = parts;
    return _this4.client.post(apiURL, params);
...
Files.prototype.getChunkedUploader = function (folderID, size, name, file, options, callback) {
  ...
  return this.createUploadSession(folderID, size, name).then(function (sessionInfo) {
    return new ChunkedUploader(_this5.client, sessionInfo, file, size, options);
  }).asCallback(callback);
};
...
Files.prototype.getNewVersionChunkedUploader = function (fileID, size, file, options, callback) {
  ...
  return this.createNewVersionUploadSession(fileID, size).then(function (sessionInfo) {
    return new ChunkedUploader(_this6.client, sessionInfo, file, size, options);
  }).asCallback(callback);
};
...
Files.prototype.getRepresentationContent = function (fileID, representationType, options, callback) {
  ...
  return this.getRepresentationInfo(fileID, representationType).then(function (reps) {
    ...
    switch (repInfo.status.state) {
      ...
      case 'none':
      case 'pending':
        return pollRepresentationInfo(_this7.client, repInfo.info.url);
      default:
    ...
    return _this7.client.get(url, { streaming: true });
  }).asCallback(callback);
};
