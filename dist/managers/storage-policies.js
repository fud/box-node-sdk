...
StoragePolicies.prototype = {
     ...
     */
	get: function get(storagePolicyID, options, callback) {
     ...
     */
	getAll: function getAll(options, callback) {
     ...
     */
	assign: function assign(storagePolicyID, userID, callback) {
		var _this = this;

		return this.getAssignmentForTarget(userID).then(function (assignment) {
     ...
     * @returns {Promise<Object>} Promise resolving to the assignment object
     */
	getAssignment: function getAssignment(assignmentID, callback) {
     ...
     * @returns {Promise<Object>} Promise resolving to the assignment object
     */
	getAssignmentForTarget: function getAssignmentForTarget(targetID, options, callback) {
     ...
     * @returns {Promise<Object>} Promise resolving to the assignment object
     */
	createAssignment: function createAssignment(storagePolicyID, userID, callback) {
     ...
     */
	updateAssignment: function updateAssignment(assignmentID, updates, callback) {
     ...
     */
	removeAssignment: function removeAssignment(assignmentID, callback) {
