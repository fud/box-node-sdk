...
Events.prototype.getLongPollInfo = function (callback) {
	...
	var apiPath = urlPath(BASE_PATH);
	return this.client.options(apiPath, {}).then(function (response) {
...
Events.prototype.getEventStream = function (streamPosition, options, callback) {
	...
	return this.getCurrentStreamPosition().then(function (currentStreamPosition) {
		return new EventStream(self.client, currentStreamPosition, options);
	}).asCallback(callback);
};
