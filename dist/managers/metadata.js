...
Metadata.prototype = {
  ...
  */
	getTemplateSchema: function getTemplateSchema(scope, template, callback) {
  ...
  * @returns {Promise<Object>} A promise resolving to the template schema
  */
	getTemplateByID: function getTemplateByID(templateID, callback) {
  ...
  */
	getTemplates: function getTemplates(scope, callback) {
  ...
  */
	createTemplate: function createTemplate(templateName, fields, options, callback) {
  ...
  */
	updateTemplate: function updateTemplate(scope, template, operations, callback) {
  ...
  */
	deleteTemplate: function deleteTemplate(scope, template, callback) {
