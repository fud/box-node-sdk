...
module.exports = {
  ...
  */
	buildResponseError: function buildResponseError(response, message) {
		response = response || {};
  ...
  */
	buildAuthError: function buildAuthError(response, message) {
  ...
  * @returns {Errors~ResponseError} an error describing the response error
  */
	buildUnexpectedResponseError: function buildUnexpectedResponseError(response) {
  ...
  */
	unwrapAndThrow: function unwrapAndThrow(error) {
